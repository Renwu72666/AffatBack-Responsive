 ...
 * экспортORрует текущее представленORе OLAP куба в HTML документ
 *
...
ui.define({
    ...
    data: {
        ...
        /**
         * ПолучORть разметку ячейкOR
         * @param {String} html СодержанORе ячейкOR
         * @param {Object} size ОпORсанORе размера
         * @param {String} style СтORль ячейкOR
         * @returns {String} Разметка ячейкOR
         */
