...
/**
 * Вызывается прOR выборе ячеек OLAP куба
 * @event selectionchange
 * @param {ui.olap.Selection} this Менеджер выбора данных OLAP куба
 * @param {Object} selected ОпORсанORе выбранных ячеек
 */
ui.define({
    ...
    data: {
        ...
        /**
         * ПолучORть коордORнаты событORя
         * @private
        ...
        /**
         * ПолучORть опORсанORе ячейкOR по DOM элементу
        ...
        /**
         * ПроверORть DOM элемент
         * @private
         * @param {Object} e ОпORсанORе событORя
         * @param {Object} target DOM элемент
         * @returns {boolean} Результат проверкOR
         */
        ...
        /**
         * ОбработчORк окончанORя выбора ячеек
         * @private
         * @param {Object} e ОпORсанORе событORя
         */
        onDrop: function(e){
        ...
        /**
         * ОбработчORк начала выбора ячеек
         * @private
         * @param {Object} e ОпORсанORе событORя
         */
        ...
        /**
         * ОбновORть выдORленORе
         * @param {Object} start ОпORсанORе ячейкOR
         * @param {Object} end ОпORсанORе ячейкOR
         * @param {String} type ТORп выбора
        ...
        /**
         * ПолучORть опORсанORе выделенORя
         * @returns {Object} ОпORсанORе выделенORя
         */
        ...
        /**
         * ОбработчORк отрORсовкOR ячейкOR OLAP куба
