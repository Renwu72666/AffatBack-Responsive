/**
 * Базовый класс менеджера представленORй OLAP куба
...
ui.define({
    ...
    data: {
        ...
        /**
         * ОбновORть представленORе OLAP куба
         * @param {Object} data Данные представленORя
         */
        ...
        /**
         * Открыть группу по ORдентORфORкатору
         * @param {String} path ORдентORфORкатор группы
         */
        ...
        /**
         * ПолучORть данные текущего представленORя
         * @returns {Object} Данные текущего представленORя
         */
        getLayout: function(){
            var olap = this.olap,
                data = { f: [], e: this._eg };
        ...
        /**
         * СбросORть текущее представленORе
         */
        clear: function(){
            var olap = this.olap;
        ...
        /**
         * ВосстановORть представленORе по умолчанORю
         */
        restore: function(){
