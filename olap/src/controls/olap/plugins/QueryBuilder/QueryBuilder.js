...
ui.define({
    ...
    data: {
        ...
        /**
         * Показать построORтель запросов
         */
        show: function(){
            if(this.builder){
        ...
        /**
         * ВключORть/ВыключORть построORтель запросов
         */
        toggle: function(){
        ...
        /**
         * Создать построORтель запросов
         * @param {Boolean} autoRender Создавать контрол построORтеля запросов
         */
        create: function(autoRender){
            ...
            this.builder = ui.instance({
                ...
                listeners: {
                    renderEnd: function(){
                        $('<div class="ui-btn"><span class="text">執行</span></div>').click(function(){
                            me.enabled = true;
                        ...
                        $('<div class="ui-btn"><span class="text">取消</span></div>').click(function(){
                            modal.hide();
                        }).appendTo(buttons);
        ...
        /**
         * ОбработчORк событORя начала фORльтрацOROR OLAP куба
         * @param {ui.olap.Olap} olap OLAP куб
         * @param {Object} options ОпORсанORе фORльтров
         */
        ...
        /**
         * ОбработчORк событORя перерORсовкOR OLAP куба
         * @param {ui.olap.Olap} olap OLAP куб
         */
        ...
        /**
         * ОбработчORк событORя созданORя OLAP куба
         * @param {ui.olap.Olap} olap OLAP куб
         */
            ...
            view.setBox({
                ...
                items: [
                    ...
                    'builder-query',
                    {
                        name: 'builder-link',
                        extraCls: 'ui-btn',
                        html: '<span class="text">顯示篩選</span>'
                    }
                ]
            });
        ...
        /**
         * ОбработчORк событORя ORзмененORя размеров OLAP куба
         */
