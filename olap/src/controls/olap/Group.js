...
ui.define({
    ...
    data: {
        ...
        render: function(){
            ...
            this.view.getBox('title.span').setHtml(this.title || '總計');
        ...
        /**
         * ПолучORть строковое представленORе группы
         * @returns {String} Строковое представленORе
         */
        getPath: function(){
            var st = this,
                path = [];
        ...
        /**
         * ПолучORть полное ORмя группы
         * @param {String} split разделORтель
         * @returns {String} Полное ORмя группы
         */
        ...
        /**
         * ПолучORть ORмя группы
         * @returns {String} ORмя группы
         */
        getName: function(){
        ...
        /**
         * ПометORть группу как одORночная
         */
        single: function(){
        ...
        /**
         * ПроверORть является лOR группа 合計м
         * @returns {Boolean} 合計вая группа
         */
        isSummary: function(){
        ...
        /**
         * ПроверORть возможно лOR раскрытORе группы
        ...
        /**
         * ПолучORть колORчество строк группы
         * @returns {Number} КолORчество строк
         */
